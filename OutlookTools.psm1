...
try {
	...
	Write-Error -Message "Not able to create an Outlook Object,function won't work, please check if you have Outlook.Application com object installed."
...
BEGIN {
	Write-Verbose -Message "Creating Outlook as an Object"
...
PROCESS { 
	 Write-Verbose -Message "Creating Calender Invite"
...
END {
		...
		Write-Verbose -Message "Saving Calender Item"
...
BEGIN {
	try {
		...
		Write-Error -Message "$_.exception occured"
	}
...
# END of Get-OutlookTask function
